...
import {
  ...
  BarChart3, FileText, KeyRound, History,
} from 'lucide-react';
...
const navItems = [
  ...
  { to: '/attendance/edit-history', icon: History, label: 'Edit History', roles: ['ADMIN', 'SUPER_ADMIN', 'HR'], indent: true },
    ...
    <aside className={`${collapsed ? 'w-16' : 'w-60'} flex flex-col bg-slate-900 text-white transition-all duration-300 shrink-0 min-h-screen`}>
      ...
      <div className="border-t border-slate-700 p-3">
        ...
        <button
          ...
          className="flex items-center gap-3 w-full px-3 py-2 rounded-lg text-sm text-slate-300 hover:bg-indigo-600/20 hover:text-indigo-400 transition-colors mb-1"
